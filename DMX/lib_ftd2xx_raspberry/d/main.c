...
UCHAR TxBuffer[1] ;
UCHAR BitMode;
static UCHAR pan       = 85;   //0-255
static UCHAR tilt      = 85;  //0-255
static UCHAR ctrl      = 85; //0-7 008-134
static UCHAR red       = 85;
static UCHAR green     = 85;
static UCHAR blue      = 85;
static UCHAR white     = 85;
static UCHAR speed     = 85;
static UCHAR reset     = 85;
