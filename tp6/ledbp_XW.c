...
{
   printk(KERN_DEBUG "init by <xu-wang>\n");
   return 0;
}*/
...
static int __init mon_module_init(void)
{
    major = register_chrdev(0, "ledbp_XW", &fops_ledbp); // 0 est le numéro majeur qu'on laisse choisir par linux
...
{
   unregister_chrdev(major, "ledbp_XW");
   printk(KERN_DEBUG "exit by <xu-wang>\n");
}
